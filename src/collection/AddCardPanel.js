...
// The add-a-card flow, shaped for a wide sidebar: name autocomplete on top,
// then the printings of the picked name as rows that each carry their own
// finish, quantity and add button. Nothing closes afterwards: adding several
// cards in a row is the normal case, so the panel stays where the user left
// it.
