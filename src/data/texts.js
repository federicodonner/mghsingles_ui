const texts = {
  ...
  CHOOSE_VERSION: "Elegir",
  CURRENT_VERSION: "Actual",
  VERSION_CHANGED: "Versión actualizada.",
  SHIFT_BACK: "Correr desde acá un lugar atrás",
  ...
  HISTORY_EMPTY: "Todavía no tenés movimientos.",
  HIST_PURCHASE: "Compra",
  HIST_SALE: "Venta",
  HIST_CREDIT: "Crédito",
  HIST_PAYOUT: "Pago",
  HIST_CASH: "efectivo",
  HIST_CREDIT_PART: "crédito",
  HIST_MORE: "más",
  ...
  PREPARING_TITLE: "En preparación",
  PREPARING_EXPLAIN:
    "La tienda está armando estos pedidos. Te avisamos cuando puedas retirarlos.",
  PREPARING_NOTE: "La tienda está preparando tu pedido.",
  ...
  NOTIF_order_ready: "Tu pedido está listo para retirar",
  ...
  IMPORT_MOXFIELD: "Importar de Moxfield",
  MOXFIELD_URL: "Link del mazo",
  MOXFIELD_HINT:
    "Pegá el link de un mazo público de Moxfield. Sus cartas se agregan a tus deseados sin preferencias; después podés ajustarlas.",
  MOXFIELD_IMPORT: "Importar",
  MOX_ADDED: " carta(s) agregadas",
  MOX_EXISTING: " ya estaban en tu lista",
  MOX_NOTFOUND: " no se encontraron",
  RESERVE: "Reservar",
  ...
  ITS_YOURS: "Es tuya",
  CONTAINER_MINE: "Tuyo",
  REQUEST_MINE_BACK: "Pedir que me lo devuelvan",
  MINE_NOTE: "Esta carta es tuya.",
  ...
  CART_TOTAL: "Total",
  CART_CREDIT_AVAILABLE: "Crédito disponible",
