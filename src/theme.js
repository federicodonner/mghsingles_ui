...
//
// The palette is the existing brand, not MUI's defaults: orange leads on the
// storefront, teal on the admin app (see the matching file there).
export const BRAND = {
  orange: "#f16e31",
  orangeDark: "#d85c22",
  teal: "#33586b",
...
const theme = createTheme({
  palette: {
    primary: { main: BRAND.orange, dark: BRAND.orangeDark, contrastText: "#fff" },
    secondary: { main: BRAND.teal, dark: BRAND.tealDark, contrastText: "#fff" },
    error: { main: "#c0392b" },
